...
from .views import register_user, login_user,store_user_basic_data, get_user_basic_data,store_user_health_profile, get_user_health_profile, store_blood_test_report, get_blood_test_report, store_metabolic_panel, get_metabolic_panel, store_liver_function_test, get_liver_function_test, store_medication_details, get_medication_details, get_food_nutrition, get_nutrition_history, nutrition_goals, daily_nutrition_summary
...
urlpatterns = [
    ...
    path('medication-details/store/', store_medication_details, name='store_medication_details'),
    path('medication-details/get/', get_medication_details, name='get_medication_details'),
